...
<head>
    ...
    <title>APOGEE 2.0: <#if (titleProperty)?has_content>${uiLabelMap[titleProperty]}<#else>${title!}</#if></title>
...
<#if shortcutIcon?has_content>
    <link rel="shortcut icon" href="/webapp/helveticus/images/ofbiz_logo.gif" type="image/x-icon">
